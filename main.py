...
def download_data():
    for percent_complete in range(0, 101):
        st.text(f"Downloading... {percent_complete}%")
        time.sleep(0.1)
...
def plan_proportion_1(data):
    ...
    # Calculate the sum of 'Count Not Churned' for the remaining rows
    remaining_sum_notchurn = plan_data_merge_notchurned.iloc[10:]['Count Churned'].sum()
...
def combine_pdfs():
    pdf_files = ["propotion_churn_area.pdf", "propotion_churn_area_1.pdf", "propotion_churn_plan.pdf", "propotion_churn_plan_keedua.pdf", "propotion_churn_tvplan.pdf", "propotion_churn_tvplan_1.pdf", "propotion_churn_advpro.pdf", "propotion_churn_advpro_1.pdf", "full_area.pdf", "five_area.pdf", "ten_area.pdf", "full_plan.pdf", "five_plan.pdf", "ten_plan.pdf", "full_tvplan.pdf", "five_tvplan.pdf", "ten_tvplan.pdf", "full_adv.pdf", "five_adv.pdf", "ten_adv.pdf"]
...
def visualize_data_batch(data):
    ...
    #DOWNLOAD HERE
    result_all_data = data_churned
    current_date = datetime.now().strftime("%Y%m%d")
    result_all_data.name = "Data Churned"
    filename = f"{result_all_data.name}_{current_date}.csv"

    csv_data = result_all_data.to_csv(index=False)
    st.download_button("Download Here - Churned Data", data=csv_data, mime='text/csv', file_name=filename)
    ...
    #DOWNLOAD HERE
    result_all_data = data_not_churned
    current_date = datetime.now().strftime("%Y%m%d")
    result_all_data.name = "Data Not Churned"
    filename = f"{result_all_data.name}_{current_date}.csv"
    ...
    #DOWNLOAD HERE
    result_all_data = area_data_non_churned
    current_date = datetime.now().strftime("%Y%m%d")
    result_all_data.name = "Data Not Churned Area Name"
    filename = f"{result_all_data.name}_{current_date}.csv"
    ...
    #DOWNLOAD HERE
    result_all_data = plan_data_non_churned
    current_date = datetime.now().strftime("%Y%m%d")
    result_all_data.name = "Data Not Churned Plan"
    filename = f"{result_all_data.name}_{current_date}.csv"
    ...
    #DOWNLOAD HERE
    result_all_data = tvplan_data_non_churned
    current_date = datetime.now().strftime("%Y%m%d")
    result_all_data.name = "Data Not Churned Tv Plan"
    filename = f"{result_all_data.name}_{current_date}.csv"
    ...
    #DOWNLOAD HERE
    result_all_data = adv_data_non_churned
    current_date = datetime.now().strftime("%Y%m%d")
    result_all_data.name = "Data Not Churned Advance Promo"
    filename = f"{result_all_data.name}_{current_date}.csv"
    ...
    new_not_churn_data = not_churn_data.drop('Churn', axis=1)
